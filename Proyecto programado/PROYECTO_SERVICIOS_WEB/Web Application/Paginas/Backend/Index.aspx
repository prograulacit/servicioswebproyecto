...
<div style="background-image: url('../../Public/imagenes/fondo_general.png'); height: 1100px;">
    ...
    <div class="container">
        ...
        <div class="card text-center">
            <div class="card-header">
                <ul class="nav nav-pills card-header-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="navegador_administracionProductos">Administración</a>
                    </li>
                    <li class="nav-item">
        ...
        <p>
            <a class="btn btn-outline-info btn-sm" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Desplegar menú antiguo</a>
        </p>
        <div class="row">
            <div class="col">
